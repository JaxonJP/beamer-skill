...
- Never require local TeX installation for the **main compilation path**.
- Be explicit that some enhanced validation/export helpers still assume optional local utilities (for example `PyMuPDF`, `pdfinfo`, `pdf2svg`, `fc-list`).
